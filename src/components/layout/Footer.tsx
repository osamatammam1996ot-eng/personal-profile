      ...
      <div className="w-full max-w-[1200px] mx-auto px-6 md:px-10 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <div
            ...
            style={{ background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', fontSize: '0.68rem',  fontWeight: 700 }}
          >
            OT
          </div>
          <p style={{  fontWeight: 400, fontSize: '0.85rem', color: dark ? 'rgba(255,255,255,0.4)' : 'rgba(0,0,0,0.4)' }}>
        ...
        <nav className="flex items-center gap-1">
          {(cmsData.footer.links[lang] || (lang === 'en' ? ['Home', 'Work', 'About', 'Contact'] : ['الرئيسية', 'الأعمال', 'عني', 'تواصل'])).map((label: any, i: number) => (
            <button
              ...
              style={{  fontWeight: 500, fontSize: '0.85rem', color: dark ? 'rgba(255,255,255,0.45)' : 'rgba(0,0,0,0.45)' }}
